...
class FrankFrancis:
    ...
    def mission(self):
        return (
            "Building practical cybersecurity solutions through "
            "automation, continuous learning, and defensive engineering."
        )
...
<p align="left">
<img src="https://skillicons.dev/icons?i=python,bash,powershell,linux,ubuntu,docker,git,github,vscode" />
</p>
